/**
 * Lazy Initialization Points:
 * 1.	This approach creates the instance in the global access method.
 * 2.	works fine in case of the single-threaded environment but when it comes to multithreaded systems, 
